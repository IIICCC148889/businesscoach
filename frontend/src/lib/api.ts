...
export const requestPdfReport = async (payload: { config: SetupConfig; scenarios: ScenarioResult[]; selectedScenarioId: string; aiAnalysis?: AiAnalysis | null; }) => {
...
export const requestAiAnalysis = async (payload: { config: SetupConfig; scenarios: ScenarioResult[]; selectedScenarioId: string; }) => {
